      ...
      <Box display='grid' gridTemplateColumns='repeat(12, 1fr)' gridAutoRows='140px' gap='15px'>
        ...
        <Box gridColumn='span 4' gridRow='span 2' backgroundColor={colors.primary[400]} overflow='auto' >
          ...
          {mockTransactions.map((transaction, i) =>(
            <Box key={`${transaction.txId}-${i}`} display='flex' justifyContent='space-between' alignItems='center' borderBottom={`4px solid ${colors.primary[400]}`} p='15px'>
              <Box>
        ...
        <Box gridColumn='span 4' gridRow='span 2' backgroundColor={colors.primary[400]} p='30px'>
          ...
          <Box display='flex' flexDirection='column' alignItems='center' mt='20px'>
            ...
            <Typography>
                Includes extra misc expenditures and acosts
            </Typography>
          </Box>
        </Box>
